...
class NikeclothesSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        items = [i for i in range(0, 6382, 24)]

        for anchor in items:
            url = 'https://api.nike.com/cic/browse/v2?queryid=products&anonymousId=356882BA56C3E2490567C01BB0E01850&country=us&endpoint=%2Fproduct_feed%2Frollup_threads%2Fv2%3Ffilter%3Dmarketplace(US)%26filter%3Dlanguage(en)%26filter%3DemployeePrice(true)%26filter%3DattributeIds(a00f0bb2-648b-4853-9559-4cd943b7d6c6%2C0f64ecc7-d624-4e91-b171-b83a03dd8550)%26anchor%3D{}%26consumerChannelId%3Dd9a5bc42-4b9c-4976-858a-f159cf99c647%26count%3D24&language=en&localizedRangeStr=%7BlowestPrice%7D%20%E2%80%94%20%7BhighestPrice%7D'.format(anchor)
